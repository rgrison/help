...
You can share a server between two applications. This could be in cases like using the same server for both your containerized app and the MySQL server behind it.
...
Environment variables set in your manifest file will only apply during the initial build of your stack. Please refer to our documentation on [environment variables](/maestro/tutorials/env-vars.html) if you'd like to set them beyond this point.
...
For more information about **LiveLogs** and additional examples, please see the [LiveLogs help page](/maestro/how-to-guides/deployment/shells/setting-up-custom-livelogs.html).
