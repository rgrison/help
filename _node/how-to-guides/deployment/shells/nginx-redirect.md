...
Simply add this code to the _server_ section of your Nginx configuration using [CustomConfig](/node/tutorials/custom-config.html), for example on line 81. This will work even if you're not using Cloud 66.
