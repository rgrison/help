...
To restart your server, it is recommended that you <a href="/rails/how-to-guides/deployment/shells/ssh.html">SSH to your server</a> and run either of the following terminal commands:
