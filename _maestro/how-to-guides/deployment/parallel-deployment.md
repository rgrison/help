...
To activate parallel deployments, access your [Stack settings](/maestro/references/shells/toolbelt.html#settings-variables) via [Toolbelt](/maestro/quickstarts/using-cloud66-toolbelt.html) and set `deploy.parallel` to `true`. 
