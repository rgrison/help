...
If you have yet to deploy your application in a production environment, you can deploy to a reasonably sized server and use [load testing](/legacy_docker/how-to-guides/deployment/shells/optimizing-performance.html) to determine your exact needs.
