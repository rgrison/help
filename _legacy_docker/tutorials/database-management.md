...
* MySQL (or Percona if [configured via Manifest](/legacy_docker/how-to-guides/deployment/building-a-manifest-file.html#mysql))
* PostgreSQL
* MongoDB
* Redis
* Elasticsearch
...
When creating a Docker stack, you can [add as many databases as you need in your service configuration during the stack build](/maestro/tutorials/docker-service-configuration.html#database-configurations).
...
You can customize the database configuration on your servers using [CustomConfig](/legacy_docker/tutorials/custom-config-git.html). CustomConfig is available for MySQL, PostgreSQL, Redis and MongoDB.
