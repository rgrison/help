...
* Scale up a new web server and drop the old one, so the scaled up one will automatically have the [latest version](/skycap/resources/technical-specifications.html#component-versions) supported by Cloud 66.
...
1. Update your manifest file (Configuration Files -> Manifest.yml) and change the Docker and Weave version to the [latest ones](/skycap/resources/technical-specifications.html#component-versions).
