...
For **Docker stacks** this file should be pushed into [CustomConfig git](/legacy_docker/references/connect-cloud66-to-git-repo.html) Repository of the stack. This repository will be created after the stack is analysed, so you can push your deploy hooks before deployment started.
