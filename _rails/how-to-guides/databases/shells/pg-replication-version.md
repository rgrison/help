...
Remember that you can see the version of PostgreSQL to install on your stack by using a [manifest file](/rails/tutorials/getting-started-with-manifest.html), like so:
