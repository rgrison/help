...
Installing through Cloud 66 is as simple as a manifest file entry. Refer to our [Manifest file](/maestro/tutorials/getting-started-with-manifest.html) documentation for more information.
