...
Firstly, you need to [open your firewall](/rails/tutorials/service-network-configuration.html) on the first stack to allow your second stacks web servers to access the database.
