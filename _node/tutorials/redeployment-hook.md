...
Users who have signed in through Github (and who have enough access to create and edit deployement events for their stacks on GitHub) can activate continuous deployments on GitHub. To do this: access your [Stack settings](/node/references/shells/toolbelt.html#settings-variables) via the toolbelt
...
For more information please refer to the [Github Deployment API](/node/quickstarts/using-cloud66-toolbelt.html).
...
If you are manually invoking redeployments you should consider using the [Cloud 66 CommandLine Tool](/node/references/shells/toolbelt.html#redeploy-your-stack) instead, as it has additional features!
