...
<ul>
 <li><a href="/node/how-to-guides/add-ins/server-task.html">Server task</a></li>
 <li><a href="/node/how-to-guides/add-ins/shell.html">Shell command</a></li>
</ul>

<h2 id="params">Using parameters</h2>

When you are running a job on demand via dashboard or [toolbelt](/node/references/shells/toolbelt.html#job-management), you can pass parameters if you used in your command.
