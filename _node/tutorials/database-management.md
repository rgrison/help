...
* MySQL (or Percona if [configured via Manifest](/node/how-to-guides/deployment/building-a-manifest-file.html#mysql))
* PostgreSQL
* MongoDB
* Redis
* Elasticsearch
...
You can customize the database configuration on your servers using [CustomConfig](/node/tutorials/custom-config-git.html). CustomConfig is available for MySQL, PostgreSQL, Redis and MongoDB.
