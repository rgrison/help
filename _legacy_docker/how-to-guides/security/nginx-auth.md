...
You can use Cloud 66 [CustomConfig](/legacy_docker/tutorials/custom-config.html) to protect your application or parts of it with a username and password based on HTTP basic authentication.
...
3.  Now we can go ahead and customize the Nginx configuration, which you can see more about in our [Nginx CustomConfig documentation](/legacy_docker/references/nginx.html).
