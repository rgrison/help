...
2.  [Scale your application servers horizontally](/{{page.collection}}/tutorials/scaling.html) to the extent that you require.
3.  [Monitor your servers](/{{page.collection}}/how-to-guides/deployment/shells/setting-up-custom-livelogs.html) to ensure that they are able to serve your users.
