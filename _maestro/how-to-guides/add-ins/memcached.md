...
## Customize Memcached
To customize Memcached, use the below syntax in your [manifest file](/maestro/how-to-guides/deployment/building-a-manifest-file.html) and redeploy the stack with `Apply security upgrades` option.
