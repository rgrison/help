...
In addition to protecting your application (or parts of it) using [HTTP basic authentication](/legacy_docker/how-to-guides/security/nginx-auth.html), you can use Cloud 66 [CustomConfig](/legacy_docker/tutorials/custom-config.html) to block (or allow) access to your application based on IP addresses.
...
3.  Now we can go ahead and customize the Nginx configuration, which you can see more about in our [Nginx CustomConfig documentation](/legacy_docker/how-to-guides/deployment/shells/nginx-modules.html).
