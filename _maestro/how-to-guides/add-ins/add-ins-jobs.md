...
<ul>
    <li><a href="/maestro/how-to-guides/add-ins/server-task.html">Docker server task</a></li>
    <li><a href="/maestro/how-to-guides/add-ins/docker-service-task.html">Docker service task</a></li>
    <li><a href="/maestro/how-to-guides/add-ins/shell.html">Shell command</a></li>
</ul>

<h2 id="params">Using parameters</h2>

When you are running a job on demand via dashboard or [toolbelt](/maestro/references/shells/toolbelt.html#job-management), you can pass parameters if you used in your command.
